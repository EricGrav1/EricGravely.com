    ...
    videos: [
      {
        ...
        title: "Sales Coaching That Actually Works",
        description: "The coaching approach that helped me develop hundreds of reps into top performers.",
      },
      {
        id: "YOUTUBE_VIDEO_ID_2",
        title: "How to Build a Top-Performing Sales Team",
        description: "The systems, habits, and culture that separate great teams from average ones.",
      },
      {
        id: "YOUTUBE_VIDEO_ID_3",
        title: "From Sales Rep to Sales Manager",
        description: "The mindset shift and skill gaps no one talks about when you make the jump to leadership.",
      },
      {
        id: "YOUTUBE_VIDEO_ID_4",
        title: "What 10 Years in Sales Taught Me",
        description: "The real lessons from a decade in the field — from cold calling rep to building Presidents Club teams.",
      },
    ],
  },
